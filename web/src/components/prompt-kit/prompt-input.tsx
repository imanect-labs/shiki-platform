...
// prompt-kit (https://www.prompt-kit.com) の PromptInput を本リポジトリへ vendoring
// したもの（shadcn 同様にソースを取り込んで保守する方式）。MIT License。
// 変更点: import を本リポジトリの primitive に合わせ、日本語 IME 変換確定中の
// Enter を送信扱いしないガード（!isComposing）を追加している。
